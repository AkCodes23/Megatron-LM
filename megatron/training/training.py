...
def _transformer_flops(args, batch_size):
    ...
    if args.num_experts is None:
        ...
        num_moe_layers = sum(moe_layer_pattern)  # Number of 1s in .
    ...
    expansion_factor = forward_backward_expansion_factor * fma_expansion_factor * 2
    ...
    if args.multi_latent_attention:
        ...
        q_term += args.hidden_size * args.qk_pos_emb_head_dim
        ## o proj
        q_term += (args.num_attention_heads * args.v_head_dim) * args.hidden_size
        ## core attn
        q_term += args.seq_length * (args.num_attention_heads * (args.qk_head_dim + args.qk_pos_emb_head_dim)) / 2
        q_term += args.seq_length * args.num_attention_heads * args.v_head_dim / 2
    ...
    self_attn_term = (
        ...
        + self_attn_term * num_standard_attention_layers
    )
