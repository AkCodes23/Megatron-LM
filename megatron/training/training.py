...
def _mamba_layer_flops(batch_size, seq_len, hidden_size, state_dim=16,
    ...
    # FWD FLOPs
    in_proj_flops = 2 * batch_size * seq_len * hidden_size * (2 * d_in + 2 * num_groups * state_dim + nheads)
    scan_flops = 7 * batch_size * seq_len * d_in * state_dim
    out_proj_flops = 2 * batch_size * seq_len * d_in * hidden_size

    return in_proj_flops + scan_flops + out_proj_flops
